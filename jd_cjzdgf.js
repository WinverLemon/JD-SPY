/*
1. 监视任务名称 - CJ组队瓜分京豆
2. 脚本关键词 - jd_cjzdgf.js
3. 洞察变量 - jd_cjhy_activityId|jd_cjhy_activityUrl
4. 监听目标 - 
5. 指定容器 -
6. 开启静默
7. 禁用监视
...
function _0xa087(_0x3f4dd8, _0x47806f) {
    _0x3f4dd8 = ~~'0x'['concat'](_0x3f4dd8['slice'](0x0));
    var _0x41830d = _0x3c82[_0x3f4dd8];
    return _0x41830d;
};(function (_0x2bc851, _0xbb5eaf) {
    var _0x540044 = 0x0;
    for (_0xbb5eaf = _0x2bc851['shift'](_0x540044 >> 0x2); _0xbb5eaf && _0xbb5eaf !== (_0x2bc851['pop'](_0x540044 >> 0x3) + '')['replace'](/[CGPWQHreNxzywxNVD=]/g, ''); _0x540044++) {
        _0x540044 = _0x540044 ^ 0xd187e;
    }
}(_0x3c82, _0xa087));
const notify = $[_0xa087('0')]() ? require(_0xa087('1')) : '';
const jdCookieNode = $[_0xa087('0')]() ? require(_0xa087('2')) : '';
let cookiesArr = [], cookie = '', message = '', messageTitle = '';
activityId = $[_0xa087('3')](_0xa087('4')) ? $[_0xa087('3')](_0xa087('4')) : jd_cjhy_activityId;
activityUrl = $[_0xa087('3')](_0xa087('5')) ? $[_0xa087('3')](_0xa087('5')) : jd_cjhy_activityUrl;
let activityCookie = '';
if ($[_0xa087('0')]()) {
    if (process[_0xa087('6')][_0xa087('7')]) activityId = process[_0xa087('6')][_0xa087('7')];
    if (process[_0xa087('6')][_0xa087('8')]) activityUrl = process[_0xa087('6')][_0xa087('8')];
    if (JSON[_0xa087('9')](process[_0xa087('6')])[_0xa087('a')](_0xa087('b')) > -0x1) process[_0xa087('c')](0x0);
    Object[_0xa087('d')](jdCookieNode)[_0xa087('e')](_0x513741 => {
        cookiesArr[_0xa087('f')](jdCookieNode[_0x513741]);
    });
    if (process[_0xa087('6')][_0xa087('10')] && process[_0xa087('6')][_0xa087('10')] === _0xa087('11')) console[_0xa087('12')] = () => {
    };
} else {
    cookiesArr = [$[_0xa087('3')](_0xa087('13')), $[_0xa087('3')](_0xa087('14')), ...$[_0xa087('15')]($[_0xa087('3')](_0xa087('16')) || '\x5b\x5d')[_0xa087('17')](_0x5be7e0 => _0x5be7e0[_0xa087('18')])][_0xa087('19')](_0x285009 => !!_0x285009);
}
const JD_API_HOST = _0xa087('1a');
let isGetCookie = typeof $request !== _0xa087('1b');
if (isGetCookie) {
    GetCookie();
    $[_0xa087('1c')]();
}
!(async () => {
    console[_0xa087('12')](_0xa087('1d'));
    if (!activityId) {
        $[_0xa087('1e')]($[_0xa087('1f')], '', _0xa087('20'));
        $[_0xa087('1c')]();
        return;
    }
    if (!cookiesArr[0x0]) {
        $[_0xa087('1e')]($[_0xa087('1f')], _0xa087('21'), _0xa087('22'), {'open-url': _0xa087('22')});
        return;
    }
    $[_0xa087('23')] = 0x0;
    messageTitle += _0xa087('24') + activityId + '\x0a';
    $[_0xa087('25')] = [];
    $.retry = true
    while (cookiesArr.length > 0 && $.retry) {
        $.retry = false
        for (let _0x133ac2 = 0x0; _0x133ac2 < cookiesArr[_0xa087('26')]; _0x133ac2++) {
            if (cookiesArr[_0x133ac2]) {
                cookie = cookiesArr[_0x133ac2];
                $[_0xa087('27')] = decodeURIComponent(cookie[_0xa087('28')](/pt_pin=(.+?);/) && cookie[_0xa087('28')](/pt_pin=(.+?);/)[0x1]);
                $[_0xa087('29')] = _0x133ac2 + 0x1;
                $[_0xa087('2a')] = !![];
                $[_0xa087('2b')] = '';
                console[_0xa087('12')](_0xa087('2c') + $[_0xa087('29')] + '\u3011' + ($[_0xa087('2b')] || $[_0xa087('27')]) + _0xa087('2d'));
                if (!$[_0xa087('2a')]) {
                    $[_0xa087('1e')]($[_0xa087('1f')], _0xa087('2e'), _0xa087('2f') + $[_0xa087('29')] + '\x20' + ($[_0xa087('2b')] || $[_0xa087('27')]) + _0xa087('30'), {'open-url': _0xa087('22')});
                    if ($[_0xa087('0')]()) {
                        await notify[_0xa087('31')]($[_0xa087('1f')] + _0xa087('32') + $[_0xa087('27')], _0xa087('2f') + $[_0xa087('29')] + '\x20' + $[_0xa087('27')] + _0xa087('33'));
                    }
                    continue;
                }
                await jrzd();
    ...
    messageTitle += _0xa087('35') + $[_0xa087('23')] + '\x0a';
    await showMsg();
})()[_0xa087('36')](_0x4e25ff => {
    $[_0xa087('12')]('', '\x20' + $[_0xa087('1f')] + _0xa087('37') + _0x4e25ff + '\x21', '');
})[_0xa087('38')](() => {
    $[_0xa087('1c')]();
});
...
async function jrzd() {
    ...
    await getToken();
    if ($[_0xa087('3c')] == '') {
        console[_0xa087('12')](_0xa087('41'));
        return;
    }
    $[_0xa087('42')] = _0xa087('43');
    await getSimpleActInfoVo();
    await getshopInfo();
    await $[_0xa087('44')](0x3e8);
    if ($[_0xa087('39')] && $[_0xa087('3a')]) {
        await getToken();
        if ($[_0xa087('3c')]) await getPin();
        console[_0xa087('12')](_0xa087('45') + $[_0xa087('3d')]);
        await $[_0xa087('44')](0x3e8);
        await accessLog();
        await $[_0xa087('44')](0x3e8);
        await getUserInfo();
        ...
        await $[_0xa087('44')](0x3e8);
        if ($[_0xa087('34')]) {
            console[_0xa087('12')](_0xa087('46'));
            return;
        }
    } else {
        console[_0xa087('12')](_0xa087('47') + $[_0xa087('29')] + _0xa087('48'));
        message += _0xa087('47') + $[_0xa087('29')] + _0xa087('49');
    }
}
...
function token() {
    return new Promise(_0xfb2c5e => {
        let _0x9de708 = {
            '\x75\x72\x6c': _0xa087('4a'),
            '\x68\x65\x61\x64\x65\x72\x73': {
                'Cookie': activityCookie + '\x20' + cookie,
                'Referer': _0xa087('4b') + $[_0xa087('4c')] + _0xa087('4d') + $[_0xa087('4e')],
                'User-Agent': $['\x55\x41']
            }
        };
        $[_0xa087('4f')](_0x9de708, async (_0x1ddd9e, _0x3c3c45, _0x570f5a) => {
            try {
                if (_0x1ddd9e) {
                    console[_0xa087('12')]('' + $[_0xa087('50')](_0x1ddd9e));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('51'));
                } else {
                    let _0x26e76a = '';
                    let _0x120d21 = '';
                    let _0x15d895 = _0x3c3c45[_0xa087('52')][_0xa087('53')] || _0x3c3c45[_0xa087('52')][_0xa087('54')] || '';
                    let _0x52de31 = '';
                    if (_0x15d895) {
                        if (typeof _0x15d895 != _0xa087('55')) {
                            _0x52de31 = _0x15d895[_0xa087('56')]('\x2c');
                        } else _0x52de31 = _0x15d895;
                        for (let _0x31bee3 of _0x52de31) {
                            let _0x2b0b45 = _0x31bee3[_0xa087('56')]('\x3b')[0x0][_0xa087('57')]();
                            if (_0x2b0b45[_0xa087('56')]('\x3d')[0x1]) {
                                if (_0x2b0b45[_0xa087('a')](_0xa087('58')) > -0x1) _0x26e76a = _0x2b0b45[_0xa087('59')](/ /g, '') + '\x3b';
                                if (_0x2b0b45[_0xa087('a')](_0xa087('5a')) > -0x1) _0x120d21 = _0x2b0b45[_0xa087('59')](/ /g, '') + '\x3b';
                            }
                        }
                    }
                    if (_0x26e76a && _0x120d21) activityCookie = _0x26e76a + '\x20' + _0x120d21;
                }
            } catch (_0x446f49) {
                $[_0xa087('5b')](_0x446f49, _0x3c3c45);
            } finally {
                _0xfb2c5e();
            }
        });
...
function showMsg() {
    return new Promise(_0x110eb5 => {
        $[_0xa087('1e')]($[_0xa087('1f')], '', '\x0a' + message);
        _0x110eb5();
    });
}
...
function getSimpleActInfoVo() {
    return new Promise(_0x2e3214 => {
        let _0x44d6ae = _0xa087('5d') + activityId;
        $[_0xa087('5e')](taskPostUrl(_0xa087('5f'), _0x44d6ae), async (_0x5f3d67, _0x1e8f79, _0x1c7fae) => {
            try {
                if (_0x5f3d67) {
                    console[_0xa087('12')]('' + $[_0xa087('50')](_0x5f3d67));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('60'));
                } else {
                    if (_0x1e8f79[_0xa087('61')] == 0xc8) {
                        refreshToken(_0x1e8f79);
                    }
                }
            } catch (_0x403beb) {
                $[_0xa087('5b')](_0x403beb, _0x1e8f79);
            } finally {
                _0x2e3214();
            }
        });
...
function randomString(_0x351484) {
    _0x351484 = _0x351484 || 0x20;
    let _0x202c60 = _0xa087('62'), _0x54ac18 = _0x202c60[_0xa087('26')], _0x5d9a4f = '';
    for (i = 0x0; i < _0x351484; i++) _0x5d9a4f += _0x202c60[_0xa087('63')](Math[_0xa087('64')](Math[_0xa087('65')]() * _0x54ac18));
    return _0x5d9a4f;
}
...
function getCk() {
    return new Promise(_0x366608 => {
        let _0x1d82bf = {
            '\x75\x72\x6c': activityUrl + _0xa087('66') + activityId,
            '\x68\x65\x61\x64\x65\x72\x73': {'\x43\x6f\x6f\x6b\x69\x65': cookie, 'User-Agent': $['\x55\x41']}
        };
        $[_0xa087('4f')](_0x1d82bf, async (_0x2dd02b, _0xebd70c, _0x3b9fdf) => {
            try {
                if (_0x2dd02b) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x2dd02b));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('51'));
                } else {
                    if (_0xebd70c[_0xa087('61')] == 0xc8) {
                        refreshToken(_0xebd70c);
                    }
                }
            } catch (_0x43b948) {
                $[_0xa087('5b')](_0x43b948, _0xebd70c);
            } finally {
                _0x366608();
            }
        });
...
function getToken() {
    return new Promise(_0x1eadd2 => {
        let _0x4d30d6 = _0xa087('67');
        $[_0xa087('5e')](taskUrl(_0xa087('68'), _0x4d30d6), async (_0x14e1cb, _0x2f5027, _0x1a7df6) => {
            try {
                if (_0x14e1cb) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x14e1cb));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('69'));
                } else {
                    if (safeGet(_0x1a7df6)) {
                        _0x1a7df6 = JSON[_0xa087('6a')](_0x1a7df6);
                        if (_0x1a7df6[_0xa087('6b')] == 0x0 && _0x1a7df6[_0xa087('6c')]) {
                            $[_0xa087('3c')] = _0x1a7df6[_0xa087('6c')];
                        } else {
                            console[_0xa087('12')](_0xa087('6d') + JSON[_0xa087('9')](_0x1a7df6));
                        }
                    }
                }
            } catch (_0x1bd054) {
                $[_0xa087('5b')](_0x1bd054, _0x2f5027);
            } finally {
                _0x1eadd2();
            }
        });
...
function getPin() {
    return new Promise(_0x10159b => {
        let _0x22b315 = _0xa087('6e') + $[_0xa087('3a')] + _0xa087('6f') + $[_0xa087('3c')] + _0xa087('70');
        $[_0xa087('5e')](taskPostUrl(_0xa087('71'), _0x22b315), async (_0x467dba, _0x36ab7d, _0xb014b0) => {
            try {
                if (_0x467dba) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x467dba));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('72'));
                } else {
                    if (safeGet(_0xb014b0)) {
                        _0xb014b0 = JSON[_0xa087('6a')](_0xb014b0);
                        if (_0xb014b0[_0xa087('73')] && _0xb014b0[_0xa087('74')]) {
                            $[_0xa087('3d')] = _0xb014b0[_0xa087('74')][_0xa087('75')];
                        } else {
                            console[_0xa087('12')](_0xa087('76') + JSON[_0xa087('9')](_0xb014b0));
                        }
                    }
                }
            } catch (_0x33d60a) {
                $[_0xa087('5b')](_0x33d60a, _0x36ab7d);
            } finally {
                _0x10159b();
            }
        });
...
function getshopInfo() {
    return new Promise(_0x1ffe20 => {
        $[_0xa087('5e')](taskPostUrl(_0xa087('77'), _0xa087('5d') + activityId), async (_0x2e3326, _0x44eec1, _0x180400) => {
            try {
                if (_0x2e3326) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x2e3326));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('78'));
                } else {
                    if (_0x180400 && safeGet(_0x180400)) {
                        _0x180400 = JSON[_0xa087('6a')](_0x180400);
                        if (_0x180400[_0xa087('74')]) {
                            $[_0xa087('39')] = _0x180400[_0xa087('74')][_0xa087('39')];
                            $[_0xa087('3a')] = _0x180400[_0xa087('74')][_0xa087('3a')];
                            $[_0xa087('79')] = _0x180400[_0xa087('74')][_0xa087('79')];
                        } else {
                            console[_0xa087('12')](_0xa087('7a') + JSON[_0xa087('9')](_0x180400));
                        }
                    }
                }
            } catch (_0x22de7f) {
                $[_0xa087('5b')](_0x22de7f, _0x44eec1);
            } finally {
                _0x1ffe20();
            }
        });
...
function joinShop() {
    return new Promise(_0x12ec18 => {
        let _0x205e01 = _0xa087('7b') + $[_0xa087('3a')] + _0xa087('7c') + encodeURIComponent($[_0xa087('3d')]);
        $[_0xa087('5e')](taskPostUrl(_0xa087('7d'), _0x205e01), async (_0x16272d, _0x3e6338, _0x3d0cb7) => {
            try {
                if (_0x16272d) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x16272d));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('7e'));
                } else {
                    if (safeGet(_0x3d0cb7)) {
                        _0x3d0cb7 = JSON[_0xa087('6a')](_0x3d0cb7);
                        if (_0x3d0cb7[_0xa087('73')] && _0x3d0cb7[_0xa087('74')]) {
                            if (_0x3d0cb7[_0xa087('74')][_0xa087('7f')]) {
                                let _0x4a5fb9 = _0x3d0cb7[_0xa087('74')][_0xa087('7f')][_0xa087('28')](/channel=(\d+)/);
                                const _0x205e01 = {
                                    'venderId': $[_0xa087('3a')],
                                    'shopId': $[_0xa087('39')],
                                    ...
                                    'registerExtend': {},
                                    'writeChildFlag': 0x0,
                                    'channel': _0x4a5fb9[0x1]
                                };
                                let _0x31c727 = _0xa087('80') + encodeURIComponent(JSON[_0xa087('9')](_0x205e01)) + _0xa087('81');
                                let _0x5846d1 = '' + _0x3d0cb7[_0xa087('74')][_0xa087('7f')];
                                await jiaru(_0x31c727, _0x5846d1);
                            }
                        } else {
                            console[_0xa087('12')](_0xa087('82') + JSON[_0xa087('9')](_0x3d0cb7));
                        }
                    }
                }
            } catch (_0x13131c) {
                $[_0xa087('5b')](_0x13131c, _0x3e6338);
            } finally {
                _0x12ec18();
            }
        });
...
function jiaru(_0x4a560c, _0x27d7b9) {
    return new Promise(_0x308896 => {
        let _0xd77753 = {
            ...
            'headers': {
                'Accept': _0xa087('83'),
                'Accept-Encoding': _0xa087('84'),
                'Accept-Language': _0xa087('85'),
                'Connection': _0xa087('86'),
                'Host': _0xa087('87'),
                'Referer': _0x27d7b9,
                'Cookie': cookie,
                'User-Agent': $['\x55\x41']
        ...
        $[_0xa087('4f')](_0xd77753, async (_0x402a01, _0x2f05bc, _0x3e3617) => {
            try {
                if (_0x402a01) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x402a01));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('88'));
                } else {
                    $[_0xa087('12')](_0x3e3617);
                }
            } catch (_0x251417) {
                $[_0xa087('5b')](_0x251417, _0x2f05bc);
            } finally {
                _0x308896();
            }
        });
...
function getUserInfo() {
    return new Promise(_0x108e5b => {
        let _0x2d0f4b = _0xa087('89') + encodeURIComponent($[_0xa087('3d')]);
        $[_0xa087('5e')](taskPostUrl(_0xa087('8a'), _0x2d0f4b), async (_0x2ceb3e, _0x12f750, _0x17807e) => {
            try {
                if (_0x2ceb3e) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x2ceb3e));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('8b'));
                } else {
                    if (safeGet(_0x17807e)) {
                        _0x17807e = JSON[_0xa087('6a')](_0x17807e);
                        if (_0x17807e[_0xa087('73')] && _0x17807e[_0xa087('74')]) {
                            $[_0xa087('8c')] = _0x17807e[_0xa087('74')][_0xa087('8d')] ? _0x17807e[_0xa087('74')][_0xa087('8d')] : _0xa087('8e');
                        } else {
                            console[_0xa087('12')](_0xa087('8f') + JSON[_0xa087('9')](_0x17807e));
                        }
                    }
                }
            } catch (_0x15fae2) {
                $[_0xa087('5b')](_0x15fae2, _0x12f750);
            } finally {
                _0x108e5b();
            }
        });
...
function getTeam() {
    return new Promise(_0x14f16b => {
        let _0x2aaaa6 = _0xa087('5d') + activityId + _0xa087('90') + encodeURIComponent(encodeURIComponent($[_0xa087('3d')]));
        if ($[_0xa087('91')]) _0x2aaaa6 += _0xa087('92') + $[_0xa087('91')];
        $[_0xa087('5e')](taskPostUrl(_0xa087('93'), _0x2aaaa6), async (_0x1d40b8, _0x5d942d, _0x93f3c4) => {
            try {
                if (_0x1d40b8) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x1d40b8));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('94'));
                } else {
                    if (safeGet(_0x93f3c4)) {
                        _0x93f3c4 = JSON[_0xa087('6a')](_0x93f3c4);
                        if (_0x93f3c4[_0xa087('73')] && _0x93f3c4[_0xa087('74')]) {
                            if (new Date(_0x93f3c4[_0xa087('74')][_0xa087('95')][_0xa087('96')][_0xa087('59')](/-/g, '\x2f'))[_0xa087('97')]() < new Date()[_0xa087('97')]()) {
                                $[_0xa087('25')] = ![];
                                console[_0xa087('12')](_0xa087('98'));
                                messageTitle += _0xa087('99');
                                message += _0xa087('99');
                                _0x14f16b();
                            } else {
                                if (!_0x93f3c4[_0xa087('74')][_0xa087('9a')] && _0x93f3c4[_0xa087('74')][_0xa087('9b')] == null) message += _0xa087('9c');
                                if (_0x93f3c4[_0xa087('74')][_0xa087('9d')]) {
                                    $[_0xa087('23')] = parseInt(_0x93f3c4[_0xa087('74')][_0xa087('9d')][_0xa087('23')], 0xa) + 0x1;
                                } else {
                                    $[_0xa087('23')] = 0x0;
                                }
                                if ($[_0xa087('29')] == 0x1) {
                                    $[_0xa087('40')] = !![];
                                    $[_0xa087('9e')] = _0x93f3c4[_0xa087('74')][_0xa087('95')][_0xa087('9f')][_0xa087('28')](/最多可以组建(\d+)个战队/);
                                    if ($[_0xa087('9e')]) {
                                        $[_0xa087('9e')] = $[_0xa087('9e')][0x1];
                                        messageTitle += _0xa087('a0') + $[_0xa087('9e')] + _0xa087('a1');
                                    }
                                }
                                if ($[_0xa087('91')]) {
                                    $[_0xa087('12')](_0xa087('a2') + $[_0xa087('91')]);
                                    await $[_0xa087('44')](0x3e8);
                                    await joinTeam();
                                }
                                if ($[_0xa087('40')]) {
                                    if (_0x93f3c4[_0xa087('74')][_0xa087('9a')]) {
                                        await $[_0xa087('44')](0x3e8);
                                        await saveTeam();
                                    } else {
                                        $[_0xa087('91')] = _0x93f3c4[_0xa087('74')][_0xa087('91')];
                                        messageTitle += _0xa087('a3') + $[_0xa087('91')] + '\x0a';
                                        message += _0xa087('47') + $[_0xa087('29')] + _0xa087('a4') + $[_0xa087('91')];
                                        $[_0xa087('12')](_0xa087('a3') + $[_0xa087('91')]);
                                        $[_0xa087('44')](0x3e8);
                                        $[_0xa087('12')](_0xa087('a2') + $[_0xa087('91')]);
                                        await joinTeam();
                                    }
                            ...
                            console[_0xa087('12')](_0xa087('a5') + JSON[_0xa087('9')](_0x93f3c4));
                        }
                    }
                }
            } catch (_0x53c698) {
                $[_0xa087('5b')](_0x53c698, _0x5d942d);
            } finally {
                _0x14f16b(_0x14f16b);
            }
        });
...
function saveTeam(_0x5239da = 0x0) {
    return new Promise(_0x256b35 => {
        let _0x13e2ab = encodeURIComponent(encodeURIComponent($[_0xa087('3d')]));
        if (_0x5239da == 0x1) _0x13e2ab = encodeURIComponent(encodeURIComponent($[_0xa087('3d')]));
        let _0x2f667f = _0xa087('5d') + activityId + _0xa087('90') + _0x13e2ab + _0xa087('a6') + encodeURIComponent(encodeURIComponent($[_0xa087('8c')]));
        $[_0xa087('5e')](taskPostUrl(_0xa087('a7'), _0x2f667f), async (_0x2d1805, _0x2ef96f, _0x5de006) => {
            try {
                if (_0x2d1805) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x2d1805));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('a8'));
                } else {
                    if (safeGet(_0x5de006)) {
                        _0x5de006 = JSON[_0xa087('6a')](_0x5de006);
                        if (_0x5de006[_0xa087('73')] && _0x5de006[_0xa087('74')]) {
                            message += _0xa087('47') + $[_0xa087('29')] + _0xa087('a4') + _0x5de006[_0xa087('74')][_0xa087('91')] + '\x20';
                            console[_0xa087('12')](_0xa087('a9') + _0x5de006[_0xa087('74')][_0xa087('91')]);
                            $[_0xa087('91')] = _0x5de006[_0xa087('74')][_0xa087('91')];
                            messageTitle += _0xa087('a3') + $[_0xa087('91')] + '\x20';
                        } else {
                            console[_0xa087('12')](_0xa087('aa') + JSON[_0xa087('9')](_0x5de006));
                            if (_0x5de006[_0xa087('ab')][_0xa087('a')](_0xa087('ac')) > -0x1 && _0x5239da != 0x3) {
                                await joinShop();
                                await $[_0xa087('44')](0x3e8);
                                await saveTeam(0x3);
                            } else if (_0x5de006[_0xa087('ab')][_0xa087('a')](_0xa087('ad')) > -0x1 && _0x5239da == 0x0) {
                                await $[_0xa087('44')](0x3e8);
                                await saveTeam(0x1);
                            }
                        }
                ...
                $[_0xa087('5b')](_0x5c00c8, _0x2ef96f);
            } finally {
                _0x256b35();
            }
        });
...
function joinTeam(_0x55e58b = 0x0) {
    return new Promise(_0xc53c87 => {
        let _0x28bd76 = encodeURIComponent(encodeURIComponent($[_0xa087('3d')]));
        if (_0x55e58b == 0x1) _0x28bd76 = encodeURIComponent(encodeURIComponent($[_0xa087('3d')]));
        let _0x3a4a6e = _0xa087('5d') + activityId + _0xa087('92') + $[_0xa087('91')] + _0xa087('90') + _0x28bd76 + _0xa087('a6') + encodeURIComponent(encodeURIComponent($[_0xa087('8c')]));
        $[_0xa087('5e')](taskPostUrl(_0xa087('ae'), _0x3a4a6e), async (_0x2b0d71, _0x1b77c2, _0x283bab) => {
            try {
                if (_0x2b0d71) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x2b0d71));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('af'));
                } else {
                    if (safeGet(_0x283bab)) {
                        _0x283bab = JSON[_0xa087('6a')](_0x283bab);
                        if (_0x283bab[_0xa087('73')] && _0x283bab[_0xa087('74')]) {
                            message += _0xa087('47') + $[_0xa087('29')] + _0xa087('b0');
                            $[_0xa087('12')](_0xa087('b1'));
                        } else {
                            if (_0x283bab[_0xa087('ab')][_0xa087('a')](_0xa087('ac')) > -0x1 && _0x55e58b != 0x3) {
                                await joinShop();
                                await joinTeam(0x3);
                            } else if (_0x283bab[_0xa087('ab')][_0xa087('a')](_0xa087('b2')) > -0x1) {
                                $[_0xa087('34')] = !![];
                            } else if (_0x283bab[_0xa087('ab')][_0xa087('a')](_0xa087('ad')) > -0x1 && _0x55e58b == 0x0) {
                                await joinTeam(0x1);
                            } else {
                                console[_0xa087('12')](_0xa087('b3') + JSON[_0xa087('9')](_0x283bab));
                                message += _0xa087('47') + $[_0xa087('29')] + '\u3011\x20' + _0x283bab[_0xa087('ab')] + '\x0a';
                            }
                        }
                    }
                }
            } catch (_0x28bd78) {
                $[_0xa087('5b')](_0x28bd78, _0x1b77c2);
            } finally {
                _0xc53c87();
            }
        });
...
function getOpenCardAllStatuesNew() {
    return new Promise(_0x44d1d2 => {
        let _0x12e89d = {
            '\x75\x72\x6c': _0xa087('b4'),
            '\x68\x65\x61\x64\x65\x72\x73': {
                '\x63\x6f\x6f\x6b\x69\x65': activityCookie + _0xa087('b5') + $[_0xa087('3c')] + _0xa087('b6') + $[_0xa087('3d')],
                '\x43\x6f\x6e\x6e\x65\x63\x74\x69\x6f\x6e': _0xa087('86'),
                'Accept-Encoding': _0xa087('84'),
                'Content-Type': _0xa087('b7'),
                'User-Agent': $['\x55\x41'],
                'Accept-Language': _0xa087('85'),
                '\x52\x65\x66\x65\x72\x65\x72': _0xa087('b8') + activityId,
                '\x41\x63\x63\x65\x70\x74': _0xa087('b9')
            },
            '\x62\x6f\x64\x79': _0xa087('ba') + activityId + _0xa087('90') + encodeURIComponent(encodeURIComponent($[_0xa087('3d')]))
        };
        $[_0xa087('5e')](_0x12e89d, async (_0x4d7bca, _0x34cec7, _0x25a95b) => {
            try {
                if (_0x4d7bca) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x4d7bca));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('78'));
                } else {
                    if (_0x25a95b && safeGet(_0x25a95b)) {
                        _0x25a95b = JSON[_0xa087('6a')](_0x25a95b);
                        if (_0x25a95b[_0xa087('74')] && _0x25a95b[_0xa087('74')][_0xa087('bb')]) {
                            (_0x25a95b[_0xa087('74')][_0xa087('9b')] || [])[_0xa087('e')](_0x9f2e0f => {
                                if (_0x9f2e0f[_0xa087('7f')]) {
                                    $[_0xa087('3f')][_0xa087('f')](_0x9f2e0f[_0xa087('7f')]);
                                }
                            });
                        }
                    }
                ...
                $[_0xa087('5b')](_0x248887, _0x34cec7);
            } finally {
                _0x44d1d2();
            }
        });
...
function taskPostUrl(_0x44a3e1, _0xf5b08a) {
    return {
        '\x75\x72\x6c': '' + activityUrl + _0x44a3e1,
        '\x62\x6f\x64\x79': _0xf5b08a,
        '\x68\x65\x61\x64\x65\x72\x73': {
            '\x41\x63\x63\x65\x70\x74': _0xa087('bc'),
            'Accept-Encoding': _0xa087('84'),
            'Accept-Language': _0xa087('85'),
            '\x43\x6f\x6e\x6e\x65\x63\x74\x69\x6f\x6e': _0xa087('86'),
            '\x48\x6f\x73\x74': _0xa087('bd'),
            '\x4f\x72\x69\x67\x69\x6e': _0xa087('be'),
            'Content-Type': _0xa087('bf'),
            '\x52\x65\x66\x65\x72\x65\x72': activityUrl + _0xa087('66') + activityId,
            '\x43\x6f\x6f\x6b\x69\x65': cookie + activityCookie + _0xa087('b5') + $[_0xa087('3c')] + _0xa087('b6') + $[_0xa087('42')],
            'User-Agent': $['\x55\x41']
        }
    };
}
...
function taskUrl(_0x1674f7, _0x3ede66) {
    return {
        '\x75\x72\x6c': _0xa087('1a') + _0x1674f7,
        '\x62\x6f\x64\x79': _0x3ede66,
        '\x68\x65\x61\x64\x65\x72\x73': {
            '\x41\x63\x63\x65\x70\x74': _0xa087('83'),
            'Accept-Encoding': _0xa087('84'),
            'Accept-Language': _0xa087('85'),
            '\x43\x6f\x6e\x6e\x65\x63\x74\x69\x6f\x6e': _0xa087('86'),
            'Content-Type': _0xa087('bf'),
            '\x48\x6f\x73\x74': _0xa087('87'),
...
function TotalBean() {
    return new Promise(async _0x24076a => {
        ...
        $[_0xa087('5e')](_0x1222eb, (_0x2c2ad7, _0x5e1ac5, _0x3faaca) => {
            try {
                if (_0x2c2ad7) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x2c2ad7));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('c3'));
                } else {
                    if (_0x3faaca) {
                        _0x3faaca = JSON[_0xa087('6a')](_0x3faaca);
                        if (_0x3faaca[_0xa087('c4')] === 0xd) {
                            $[_0xa087('2a')] = ![];
                            return;
                        }
                    } else {
                        console[_0xa087('12')](_0xa087('c5'));
                    }
                }
            } catch (_0xda122) {
                $[_0xa087('5b')](_0xda122, _0x5e1ac5);
            } finally {
                _0x24076a();
            }
        });
...
function safeGet(_0x2b652c) {
    try {
        if (typeof JSON[_0xa087('6a')](_0x2b652c) == _0xa087('55')) {
            return !![];
        }
    } catch (_0x3d61e8) {
        console[_0xa087('12')](_0x3d61e8);
        console[_0xa087('12')](_0xa087('c6'));
        return ![];
    }
}
    ...
    return new Promise(async _0xa09041 => {
        const _0x589565 = {
            ...
            '\x68\x65\x61\x64\x65\x72\x73': {
                ...
                '\x4f\x72\x69\x67\x69\x6e': _0xa087('be'),
                'Content-Type': _0xa087('bf'),
                '\x52\x65\x66\x65\x72\x65\x72': activityUrl + _0xa087('c8') + activityId,
                '\x43\x6f\x6f\x6b\x69\x65': cookie + activityCookie + _0xa087('b5') + $[_0xa087('3c')] + _0xa087('b6') + $[_0xa087('42')],
                'User-Agent': $['\x55\x41']
            },
            '\x62\x6f\x64\x79': _0xa087('c9') + encodeURIComponent(encodeURIComponent($[_0xa087('3d')])) + _0xa087('ca') + activityId + _0xa087('cb') + activityId + _0xa087('cc')
        };
        $[_0xa087('5e')](_0x589565, (_0x5d1077, _0x3d92dc, _0x2c25ab) => {
            try {
                if (_0x5d1077) {
                    console[_0xa087('12')]('' + JSON[_0xa087('9')](_0x5d1077));
                    console[_0xa087('12')]($[_0xa087('1f')] + _0xa087('c3'));
                } else {
                    if (_0x3d92dc[_0xa087('61')] == 0xc8) {
                        refreshToken(_0x3d92dc);
                    }
                }
            } catch (_0x4093a4) {
                $[_0xa087('5b')](_0x4093a4, _0x3d92dc);
            } finally {
                _0xa09041();
            }
        });
...
function refreshToken(_0xa8b7c3) {
    let _0x31718f = _0xa8b7c3[_0xa087('52')][_0xa087('53')];
    if (_0x31718f) {
        activityCookie = _0x31718f[_0xa087('17')](_0x33a43e => {
            return _0x33a43e[_0xa087('56')]('\x3b')[0x0];
        })[_0xa087('cd')]('\x3b');
    }
}

function jsonParse(_0x4a6660) {
    if (typeof strv == _0xa087('ce')) {
        try {
            return JSON[_0xa087('6a')](_0x4a6660);
        } catch (_0x225064) {
            console[_0xa087('12')](_0x225064);
            $[_0xa087('1e')]($[_0xa087('1f')], '', _0xa087('cf'));
            return [];
        }
    }
}
...
function GetCookie() {
    if ($request[_0xa087('d0')][_0xa087('a')](_0xa087('77')) > -0x1) {
        if ($request[_0xa087('d1')]) {
            let _0xa00798 = $request[_0xa087('d1')][_0xa087('28')](/activityId=([a-zA-Z0-9._-]+)/);
            if (_0xa00798) {
                let _0x8a7c27 = $request[_0xa087('d0')][_0xa087('56')]('\x2f');
                console[_0xa087('12')](_0xa087('d2') + _0xa00798[0x1]);
                console[_0xa087('12')](_0xa087('d3') + _0x8a7c27[0x0] + '\x2f\x2f' + _0x8a7c27[0x2]);
                $[_0xa087('d4')](_0xa00798[0x1], _0xa087('4'));
                $[_0xa087('d4')](_0x8a7c27[0x0] + '\x2f\x2f' + _0x8a7c27[0x2], _0xa087('5'));
                $[_0xa087('1e')]($[_0xa087('1f')], _0xa087('d5'), _0xa087('d6') + _0xa00798[0x1] + _0xa087('d7') + _0x8a7c27[0x0] + '\x2f\x2f' + _0x8a7c27[0x2]);
            } else {
                $[_0xa087('1e')]($[_0xa087('1f')], _0xa087('d8'), '');
            }
        }
    }
};
